            ...
            <div class="container logo-wrap">
              <div class="row pt-5">
                <div class="col-12 text-center">
                  ...
                  <h1 class="site-logo"><a href="index.html">FONOTROPICA</a></h1>
                </div>
              </div>
            </div>
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarMenu">
                  <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="quem_somos.html">Quem somos nós</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="equipe.html">Equipe</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="coleção.html">A coleção</a>
                      </li>
    
                      <li class="nav-item">
                          <a class="nav-link" href="#">A plataforma</a>
                        </li>
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="/wordify-master/login/login.html">Login</a>
                    </li>
                  </ul>
        ...
        <div class="container">
          <div class="row mb-5">
            <div class="col-md-4">
              ...
              <p class="mb-4">
                <img src="images/video-play.png" alt="Image placeholder" class="img-fluid">
              </p>

              <p>Fonotropica. <a href="quem_somos.html">Leia Mais</a></p>
            </div>
                ...
                <div class="col-md-7">
                  ...
                  <div class="post-entry-sidebar">
                    <ul>
                      <li>
                        <a href="">
                          <img src="images/video-play.png" alt="Image placeholder" class="mr-4">
                          <div class="text">
                            <h4>- Nome da postagem -</h4>
                            <div class="post-meta">
                              <span class="mr-2">Mês Dia, Ano </span> &bullet;
                            </div>
                          </div>
                        </a>
                      </li>
                ...
                <div class="col-md-4">
                  ...
                  <div class="mb-5">
                    ...
                    <ul class="list-unstyled">
                      <li><a href="quem_somos.html">Quem somos nós</a></li>
          ...
          <div class="row">
            ...
            <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Fonotropica</span>. All Rights Reserved. Design by UFBA - Fonotropica</a></p>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
